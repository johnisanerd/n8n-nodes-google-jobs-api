...
import { properties } from './ApifyGoogleJobs.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'CkLDY9GAQf6QlP6GP' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-jobs-api' as string;
export const CLASS_NAME = 'ApifyGoogleJobs' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-jobs-app' as string;

export const DISPLAY_NAME = 'Google Jobs' as string;
export const DESCRIPTION =
	'Search Google Jobs listings and return job titles, companies, locations, posting dates, and apply links' as string;

export class ApifyGoogleJobs implements INodeType {
